        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h3 class="mb-2">Profil Toko</h3>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Profile Toko</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <h2 class="font-24 mb-0">
                              <?php echo (isset($data['shop']['name'])) ? $data['shop']['name'] : 'Nama Toko' ;?>
                            </h2>
                        </div>
                    </div>
                    <div class="card-body border-top">
                        ...
                        <div class="">
                            ...
                            <li class="mb-2">
                              ...
                              <?php echo (isset($data['shop']['email'])) ? $data['shop']['email'] : 'email@email.com' ;?>
                          </li>
                            <li class="mb-0">
                              <i class="fas fa-fw fa-phone mr-2"></i>
                              <?php echo (isset($data['shop']['name'])) ? $data['shop']['name'] : '(000) 123 4567' ;?>
                          </li>
                        </ul>
                        </div>
                    </div>
