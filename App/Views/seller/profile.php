                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Tampilkan Profile</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                  ...
                  <div class="card-body">
                    <form action="/profile-edit" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          ...
                          <input id="inputText3" name="name" placeholder="Nama" type="text" class="form-control" value="<?php echo $name ?>" readonly>
                      </div>

                      <div class="form-group">
                          <label for="inputEmail">Alamat Email</label>
                          <input id="inputEmail" type="email" placeholder="name@example.com" name="email" class="form-control" value="<?php echo $email ?>" readonly>
                          <p>Gunakan Satu Email untuk selamanya</p>
                      </div>

                      <div class="form-group">
                          <label for="inputText4" class="col-form-label">Nomor Telepon</label>
                          <input id="inputText4" type="number" class="form-control" placeholder="Nomor Telepon" name="phonenumber" value="<?php echo $phonenumber; ?>" readonly>
                      </div>

                      <div class="form-group">
                          <label for="exampleFormControlTextarea1">Deskripsi Toko</label>
                          <textarea readonly class="form-control" id="exampleFormControlTextarea1" rows="3" name="description"><?php echo $description; ?></textarea>
                      </div>
                    </div>
                    ...
                    <div class="card-body border-top">
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputText3" name="zipcode" type="text" class="form-control" value="<?php echo $zipcode; ?>" readonly>
                        </div>
                          
                        <div class="form-group">
                            <label for="inputText3" class="col-form-label">Kota</label>
                            <input id="inputText3" name="city" type="text" class="form-control" value="<?php echo $city; ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label for="inputText3" class="col-form-label">Provinsi</label>
                            <input id="inputText3" name="province" type="text" class="form-control" value="<?php echo $province; ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Alamat Lengkap</label>
                            <textarea name="address" readonly class="form-control" id="exampleFormControlTextarea1" rows="3"><?php echo trim($address); ?></textarea>
                        </div>
                      </form>
                    </div>
                  </div>
