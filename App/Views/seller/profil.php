                  ...
                  <div class="card-body">
                    <form action="/profile-edit" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <input id="inputText3" name="name" placeholder="Nama" type="text" class="form-control" value="<?php echo $name ?>" disabled>
                      </div>

                      <div class="form-group">
                          <label for="inputEmail">Alamat Email</label>
                          <input id="inputEmail" type="email" placeholder="name@example.com" name="email" class="form-control" value="<?php echo $email ?>" disabled>
                          <p>Gunakan Satu Email untuk selamanya</p>
                      </div>

                      <div class="form-group">
                          <label for="inputText4" class="col-form-label">Nomor Telepon</label>
                          <input id="inputText4" type="number" class="form-control" placeholder="Nomor Telepon" name="phonenumber" value="<?php echo $phonenumber; ?>" disabled>
                      </div>

                      <div class="form-group">
                          <label for="exampleFormControlTextarea1">Deskripsi Toko</label>
                          <textarea class="form-control" disabled id="exampleFormControlTextarea1" rows="3" name="description"><?php echo $description; ?></textarea>
                      </div>
                    </div>
                    ...
                    <div class="card-body border-top">
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputText3" name="street" type="text" class="form-control" value="<?php echo $street; ?>" disabled>
                        </div>

                        <div class="form-group">
                            <label for="inputText3" class="col-form-label">Kode Pos</label>
                            <input id="inputText3" name="zipcode" type="text" class="form-control" value="<?php echo $zipcode; ?>" disabled>
                        </div>
                          
                        <div class="form-group">
                            <label for="inputText3" class="col-form-label">Kota</label>
                            <input id="inputText3" name="city" type="text" class="form-control" value="<?php echo $city; ?>" disabled>
                        </div>

                        <div class="form-group">
                            <label for="inputText3" class="col-form-label">Provinsi</label>
                            <input id="inputText3" name="province" type="text" class="form-control" value="<?php echo $province; ?>" disabled>
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Alamat Lengkap</label>
                            <textarea name="address" disabled class="form-control" id="exampleFormControlTextarea1" rows="3"><?php echo trim($address); ?></textarea>
                        </div>
                      </form>
                    </div>
                  </div>
